      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          ...
          Text('Amazon Pay'),
            ...
            const Image(image:AssetImage('assets/images/amazon.png') ,
             width: 70,
                height: 70,
                fit: BoxFit.cover,),
          ...
          Text('Credit Card"'),
            ...
            const Image(image:AssetImage('assets/images/vm.png') ,
             width: 70,
                // height: 40,
                fit: BoxFit.cover,),
          ...
          Text('PayPal'),
            ...
            const Image(image:AssetImage('assets/images/pay.png') ,
             width: 70,
                // height: 40,
                fit: BoxFit.cover,),
          ...
          Text('Google Pay'),
            ...
            const Image(image:AssetImage('assets/images/gopay.png') ,
             width: 70,
                // height: 70,
                fit: BoxFit.cover,),
          ...
          style: TextStyle(
            ...
            const SizedBox(height: 70),
              ElevatedButton(
                ...
                child:Text(" Confirm Payment",style: const TextStyle(color: Colors.white)),
